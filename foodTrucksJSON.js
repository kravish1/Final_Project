db.trucks.insert([
  ...
  },
  {
    ...
    foodType: ['Vegan Sandwiches', 'Sandwiches'],
    schedule: [],
    payment: [],
    description: '',
    website: '',
  ...
  {
    name: 'Biscuit Box',
    foodType: ['Sandwiches/Breakfast', 'Sandwiches', 'Breakfast'],
    schedule: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'],
    payment: ['Cards'],
  ...
  {
    name: 'Bomba Fusion',
    foodType: ['Korean/Mexican Fusion'],
    schedule: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'],
    payment: ['Cash', 'Cards'],
    description: '',
  ...
  {
    name: 'Charlie\'s',
    foodType: ['Burgers/Cheesesteaks', 'Burgers'],
  ...
  {
    name: 'Chick\'n Fix',
    foodType: ['American/Fillipino', 'Fillipino'],
    schedule: ['Monday', 'Tuesday', 'Wednesday', 'Thursday'],
    payment: ['Cash', 'Cards'],
  ...
  },
  {
    ...
    foodType: ['Sandwiches/Burgers', 'Sandwiches', 'Burgers'],
  ...
  },
  {
    ...
    foodType: ['Hot Dogs', 'sausages', 'wood fired pizza', 'Pizza'],
    schedule: [],
    payment: ['Cash', 'Cards'],
  ...
  {
    name: 'Don Lucho\'s',
    foodType: ['Peruvian Sandwiches', 'Sandwiches'],
    schedule: [],
    payment: ['Cash', 'Cards'],
  ...
  {
    name: 'El Animal',
    foodType: ['Cuban and Argentinian', 'Cuban', 'Argentinian'],
    schedule: [],
    payment: ['Cash', 'Cards'],
